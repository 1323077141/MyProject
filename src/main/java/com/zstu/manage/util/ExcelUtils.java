...
import com.zstu.manage.bean.ExcelBean;
...
public class ExcelUtils {
    private final static String excel2003L = ".xls"; //2003-的版本
    private final static String excel2007U = ".xlsx"; //2007+的版本
     ...
     */
    public static XSSFWorkbook createExcelFile(@SuppressWarnings("rawtypes") Class clazz, @SuppressWarnings("rawtypes") List objs, Map<Integer, List<ExcelBean>> map, String sheetName) throws
            Exception{
        // 创建新的Excel工作簿
...
//        font1.setBold(XSSFFont.BOLDWEIGHT_BOLD);
...
//        fontStyle2.setAlignment(XSSFCellStyle.ALIGN_CENTER); // 居中
    ...
    public static void createTableRows(XSSFSheet sheet,
                                       Map<Integer, List<ExcelBean>> map, @SuppressWarnings("rawtypes") List objs, @SuppressWarnings("rawtypes") Class clazz)
            throws Exception{
